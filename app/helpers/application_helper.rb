module ApplicationHelper
  ...
  # 追加した属性 data-default-favicon は主にテスト用で、
  # この要素がデフォルトのアイコン（モデルにfaviconがないことの代替）であることの印としています。
  def default_favicon
    <<-END_OF_STRING
    <svg data-default-favicon="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="inline" viewBox="0 0 16 16">
